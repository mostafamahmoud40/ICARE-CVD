  ...
  careTimeline: [
    {
      ...
      detail: "External lab — upload your report PDF or photo after the test",
    ...
    },
    {
      ...
      detail: "Ordered at your last cardiology visit — results not uploaded yet",
    ...
    },
    {
      ...
      detail: "In-clinic review — bring home BP readings",
      dueAt: "2026-06-25T09:00:00Z",
      status: "scheduled",
      doctorName: "Dr. Hossam El-Sayed",
      href: "/appointments",
    },
    {
      id: "task-appt-1",
      ...
      detail: "ICARE-CVD Main Center · Room 4C",
      dueAt: "2026-06-28T09:00:00Z",
      status: "scheduled",
      doctorName: "Dr. Mai Ramadan",
      href: "/appointments",
    },
  ],
}
