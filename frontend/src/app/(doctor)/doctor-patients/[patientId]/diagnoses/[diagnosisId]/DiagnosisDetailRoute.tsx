...
export function DiagnosisDetailRoute({
  patientId,
  diagnosisId,
}: {
  patientId: string
          ...
          return (
            <main className="flex flex-1 flex-col items-center justify-center gap-4 bg-[#F9F8F5] px-6 py-16">
              ...
              <p className="text-[13px] font-medium text-[#6B7870]">
                This problem list entry may have been removed.
              </p>
              <Button
                asChild
                size="sm"
                className="h-8 rounded-lg bg-[#1A5345] px-4 text-[12px] font-bold text-white hover:bg-[#133F34]"
              >
