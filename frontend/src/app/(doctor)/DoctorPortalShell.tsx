...
export function DoctorPortalShell({
  ...
  return (
    <SidebarProvider defaultOpen>
      <DoctorPortalShellInner pathname={pathname}>
        {children}
      </DoctorPortalShellInner>
    </SidebarProvider>
  )
}

function DoctorPortalShellInner({
  pathname,
  children,
}: {
  pathname: string
                  ...
                  <SidebarMenuButton
                    ...
                    render={
                      <button type="button" aria-label="Doctor profile">
                        <div className="flex size-8 items-center justify-center rounded-full bg-primary/10 text-primary" aria-hidden="true">
